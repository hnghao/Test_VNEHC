...
#include "taskCheckVoltSig.h"

taskCheckVoltSig taskCheckVoltSig1;
...
#define DS18B20_PIN A1     // Digital pin connected to the sensor (Uno/Creator)
...
void setup()
{
  ...
  if(taskCheckVoltSig1.checkAnalogA1() == 0)
  {
    while(1);
  }
  sensor.begin();
